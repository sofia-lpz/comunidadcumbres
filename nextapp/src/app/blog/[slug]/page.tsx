    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-12 text-center">
        ...
        <p className="text-gray-600">
          El post que buscas no existe o no está publicado.
        </p>
      </div>
    );
  }
