...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  // Layout estático para admin (sin autenticación por ahora)
  return (
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-[#222222]">
                Panel de Administración (Modo Estático)
              </h1>
            </div>
            
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">
                admin@comunidadcumbres.org (demo)
              </span>
      ...
      <nav className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            <a 
              href="/admin" 
              className="py-4 px-1 border-b-2 text-sm font-medium border-[#5D84C4] text-[#5D84C4]"
            >
              Dashboard
            </a>
            <a 
              href="/admin/programs" 
              className="py-4 px-1 border-b-2 text-sm font-medium border-transparent text-gray-500 hover:text-gray-700"
            >
              Programas
            </a>
            <a 
...
// TODO: Descomentar cuando se reactive la autenticación
/*
'use client';
import { useEffect, useState } from 'react';
import { useRouter, usePathname } from 'next/navigation';
