...
const impactCards: ImpactCard[] = [
  {
    ...
    subtitle: "Tu donación tiene más impacto cuando la das al Patronato Cumbres",
    description: "90% del dinero que el Patronato Cumbres gasta va hacia nuestro trabajo que salva vidas y transforma comunidades.",
  ...
  },
  {
    ...
    subtitle: "Somos una de las organizaciones comunitarias más importantes de la región",
    description: "Trabajamos en múltiples comunidades, llevando esperanza y desarrollo a familias que más lo necesitan.",
  ...
  },
  {
    ...
    description: "Desde infraestructura hasta educación, cada iniciativa está diseñada para crear un impacto duradero en la comunidad.",
  ...
  },
  {
    ...
    description: "A través de nuestros programas integrales, brindamos oportunidades reales de crecimiento y bienestar a familias enteras.",
    image: "/images/hero-carousel/ProyectoUtilesEscolares.jpg",
    href: "/voluntariado",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 leading-tight">
            Cada día, junto contigo, el{" "}
            <span className="text-[#5D84C4]">Patronato Cumbres</span>{" "}
            salva vidas y ayuda a miles de personas a encontrar el camino hacia una vida mejor en toda la región.
          </h2>
          ...
          {impactCards.map((card, index) => (
            ...
            >
              ...
              <div className={getOverlayClasses(card.overlayPosition)}>
                <div className={card.overlayPosition === 'right' ? 'lg:text-right' : ''}>
                  ...
                  {/* Hover indicator */}
                  <div className={`mt-4 lg:mt-6 inline-flex items-center text-white font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-y-0 translate-y-2 ${
                    card.overlayPosition === 'right' ? 'lg:flex-row-reverse' : ''
                  }`}>
                    <span className={card.overlayPosition === 'right' ? 'ml-2' : 'mr-2'}>Conoce más</span>
                    <svg className={`w-5 h-5 transform group-hover:${card.overlayPosition === 'right' ? '-translate-x-1' : 'translate-x-1'} transition-transform`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={card.overlayPosition === 'right' ? "M7 16l-4-4m0 0l4-4m-4 4h18" : "M17 8l4 4m0 0l-4 4m4-4H3"} />
                    </svg>
                  </div>
                </div>
              </div>
